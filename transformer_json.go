	...
	case reflect.Struct:
		...
		for _, meta := range metas {
			if meta.HasPermission(roles.Read, context.Context) {
				...
				if relationship := meta.FieldStruct.Schema.Relationships.Relations[meta.FieldName]; meta.Resource != nil && (meta.FieldStruct != nil && relationship != nil && (relationship.Type == "has_one" || relationship.Type == "has_many" || meta.Type == "single_edit" || meta.Type == "collection_edit")) {
